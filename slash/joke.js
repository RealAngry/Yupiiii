...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('joke')
        .setDescription('Get a random Hindi/Hinglish joke')
        .addStringOption(option => 
            option.setName('category')
                .setDescription('The category of joke to get')
                .setRequired(false)
                .addChoices(
                    { name: 'Santa Banta', value: 'santa-banta' },
                    { name: 'Student Teacher', value: 'student' },
                    { name: 'Husband Wife', value: 'pati-patni' },
    ...
    async execute(interaction, client) {
        ...
        try {
            // Defer reply to give time to fetch the joke
            ...
            if (!joke) {
                return interaction.editReply('Sorry, koi joke nahi mila. Baad mein try karo.');
            }
            ...
            const embed = new EmbedBuilder()
                ...
                .setFooter({ text: `Category: ${joke.category} | Try different categories with /joke category:` })
                .setTimestamp();
            ...
            if (interaction.deferred) {
                await interaction.editReply('Joke laane mein kuch gadbad ho gayi. Baad mein try karo.');
            } else {
                await interaction.reply({ 
                    content: 'Joke laane mein kuch gadbad ho gayi. Baad mein try karo.',
                    ephemeral: true 
                });
            }
        }
